        ...
        <div class="tm-container-wide tm-nopadding">
            <ul class="tm-team list-unstyled clearfix">
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Ihor-Pyk.jpg" alt="Ihor Pyk" />
                        </div>
                        <div>
                            <h5>Ihor Pyk</h5>
                            <p>Front-end Developer</p>
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Irene-Andriyevska.jpg" alt="Irene Andriyevska" />
                        </div>
                        <div>
                            <h5>Irene Andriyevska</h5>
                            <p>Front-end Developer</p>
                        </div>
                    </div>
                    <div class="tm-overlay-block"></div>
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Nazar-Danyliak.jpg" alt="Nazar Danyliak" />
                        </div>
                        <div>
                            <h5>Nazar Danyliak</h5>
                            <p>Front-end Developer</p>
                        </div>
                    </div>
                    <div class="tm-overlay-block"></div>
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Oleg-Shumovsky.jpg" alt="Oleg Shumovsky" />
                        </div>
                        <div>
                            <h5>Oleg Shumovsky</h5>
                            <p>Front-end Developer</p>
                        </div>
                    </div>
                    <div class="tm-overlay-block"></div>
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Vitaliy-Rachok.jpg" alt="Vitaliy Rachok" />
                        </div>
                        <div>
                            <h5>Vitaliy Rachok</h5>
                            <p>Front-end Developer</p>
                        </div>
                    </div>
                    <div class="tm-overlay-block"></div>
                ...
                <li>
                    <div class="tm-front-block">
                        <div>
                            <img src="img/meet-us/Zoriana-Bazar.jpg" alt="Zoriana Bazar" />
                        </div>
                        <div>
                            <h5>Zoriana Bazar</h5>
                            <p>Front-end Developer</p>
