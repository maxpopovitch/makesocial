...
<main id="what-you-get-support-content" class="tm-bg-01">
    <div class="container tm-sect-01">
        <div class="col-md-5">
            <h1 class="h2 text-uppercase tm-text-line-normal tm-nomargin"><strong>Post-launch Analytics, Support</strong></h1>
            <hr class="tm-hr-04"/>
            <img class="img-responsive" src="img/services/search-engine-optimization.svg" alt="Analytics and Support" />
        </div>
        <div class="col-md-7">
            ...
            <p class="tm-increased tm-colored"><strong>Evolution Marketing</strong></p>
            <p>We will gladly phase out the release of your features to your users to strategically deploy functionality with certain intervals, so your users always want to come back for more and see what's new.</p>
            <p><strong>We want you to succeed and we will do everything in our power to remain a part of your journey.</strong></p>
        </div>
    </div>