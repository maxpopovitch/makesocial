            ...
            <ul class="tm-whatwedo list-unstyled clearfix">
                ...
                <li>
                    <a href="mobile-application-development">
                        <svg class="tm-icon tm-smartphone" preserveAspectRatio= "xMinYMin meet" viewBox="0 0 1024 1024">
                        <path class="path1" d="M537.6 921.6h-51.2c-14.138 0-25.6-11.461-25.6-25.6s11.462-25.6 25.6-25.6h51.2c14.139 0 25.6 11.461 25.6 25.6s-11.461 25.6-25.6 25.6z"></path><path class="path2" d="M742.4 1024h-460.8c-42.347 0-76.8-34.451-76.8-76.8v-870.4c0-42.347 34.453-76.8 76.8-76.8h460.8c42.349 0 76.8 34.453 76.8 76.8v870.4c0 42.349-34.451 76.8-76.8 76.8zM281.6 51.2c-14.115 0-25.6 11.485-25.6 25.6v870.4c0 14.115 11.485 25.6 25.6 25.6h460.8c14.115 0 25.6-11.485 25.6-25.6v-870.4c0-14.115-11.485-25.6-25.6-25.6h-460.8z"></path><path class="path3" d="M691.2 819.2h-358.4c-14.138 0-25.6-11.461-25.6-25.6v-665.6c0-14.138 11.462-25.6 25.6-25.6h358.4c14.139 0 25.6 11.462 25.6 25.6v665.6c0 14.139-11.461 25.6-25.6 25.6zM358.4 768h307.2v-614.4h-307.2v614.4z"></path>
                        </svg>
                ...
                <li>
                    <a href="corporate-identity-and-brand-design">
                        <svg class="tm-icon tm-smartphone" preserveAspectRatio= "xMinYMin meet" viewBox="0 0 1024 1024">
                        <path class="path1" d="M537.6 921.6h-51.2c-14.138 0-25.6-11.461-25.6-25.6s11.462-25.6 25.6-25.6h51.2c14.139 0 25.6 11.461 25.6 25.6s-11.461 25.6-25.6 25.6z"></path><path class="path2" d="M742.4 1024h-460.8c-42.347 0-76.8-34.451-76.8-76.8v-870.4c0-42.347 34.453-76.8 76.8-76.8h460.8c42.349 0 76.8 34.453 76.8 76.8v870.4c0 42.349-34.451 76.8-76.8 76.8zM281.6 51.2c-14.115 0-25.6 11.485-25.6 25.6v870.4c0 14.115 11.485 25.6 25.6 25.6h460.8c14.115 0 25.6-11.485 25.6-25.6v-870.4c0-14.115-11.485-25.6-25.6-25.6h-460.8z"></path><path class="path3" d="M691.2 819.2h-358.4c-14.138 0-25.6-11.461-25.6-25.6v-665.6c0-14.138 11.462-25.6 25.6-25.6h358.4c14.139 0 25.6 11.462 25.6 25.6v665.6c0 14.139-11.461 25.6-25.6 25.6zM358.4 768h307.2v-614.4h-307.2v614.4z"></path>
                        </svg>
                ...
                <li>
                    <a href="strategic-planning-services">
                        <svg class="tm-icon tm-smartphone" preserveAspectRatio= "xMinYMin meet" viewBox="0 0 1024 1024">
                        <path class="path1" d="M537.6 921.6h-51.2c-14.138 0-25.6-11.461-25.6-25.6s11.462-25.6 25.6-25.6h51.2c14.139 0 25.6 11.461 25.6 25.6s-11.461 25.6-25.6 25.6z"></path><path class="path2" d="M742.4 1024h-460.8c-42.347 0-76.8-34.451-76.8-76.8v-870.4c0-42.347 34.453-76.8 76.8-76.8h460.8c42.349 0 76.8 34.453 76.8 76.8v870.4c0 42.349-34.451 76.8-76.8 76.8zM281.6 51.2c-14.115 0-25.6 11.485-25.6 25.6v870.4c0 14.115 11.485 25.6 25.6 25.6h460.8c14.115 0 25.6-11.485 25.6-25.6v-870.4c0-14.115-11.485-25.6-25.6-25.6h-460.8z"></path><path class="path3" d="M691.2 819.2h-358.4c-14.138 0-25.6-11.461-25.6-25.6v-665.6c0-14.138 11.462-25.6 25.6-25.6h358.4c14.139 0 25.6 11.462 25.6 25.6v665.6c0 14.139-11.461 25.6-25.6 25.6zM358.4 768h307.2v-614.4h-307.2v614.4z"></path>
                        </svg>
    ...
    <section class="tm-howwework text-center text-md-left">
        <div class="tm-sect-02 tm-bg-02">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="tm-title-02 text-uppercase"><strong>How we work</strong></h3>
                        <a href="our-process" class="tm-cta">read more about our process</a>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="tm-iconholder">
                                    <img src="img/icon-plan.svg" alt="Plan" />
                                </div>
                                <h5 class="tm-titlecolor text-uppercase"><strong>1. Plan</strong></h5>
                                <p class="tm-description tm-titlecolor">Together with the client we estimate and clearly define top priorities.</p>
                            </div>
                            <div class="col-md-4">
                                <div class="tm-iconholder">
                                    <img src="img/icon-collaborate.svg" alt="Collaborate" />
                                </div>
                                <h5 class="tm-titlecolor text-uppercase"><strong>2. Collaborate</strong></h5>
                                <p class="tm-description tm-titlecolor">Our work is organised in sprints, and progress is monitored daily.</p>
                            </div>
                            <div class="col-md-4">
                                <div class="tm-iconholder">
                                    <img src="img/icon-deliver.svg" alt="Deliver" />
                                </div>
                                <h5 class="tm-titlecolor text-uppercase"><strong>3. Deliver</strong></h5>
                                <p class="tm-description tm-titlecolor">A product, ready to be handed to a client or shown to a stakeholder is presented.</p>
                            </div>
                        </div>
                    </div>
                </div>
