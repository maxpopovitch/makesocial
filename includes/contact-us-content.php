            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="quote">
                    <div class="container tm-sect-01">
                        ...
                        <form enctype="multipart/form-data" action="#" method="POST" id="form-quote" data-toggle="validator">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="tm-file-wrapper">
                                            <input type="file" class="form-control" id="quote-file" name="quote-file" accept="image/*" />
                                        </span>
                                        <div>browse</div>
