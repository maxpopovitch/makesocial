            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <p class="tm-default-p tm-text-line-15 tm-margin-01">
                        ...
                        PHP, JavaScript (jQuery, NodeJS)<br />
                        <strong class="tm-text-accent">Databases:</strong><br />
                        MySQL, MongoDB<br />
                    </p>
                    <p class="tm-default-p">StrongLoop API, PhoneGap</p>
                    <img class="img-responsive" src="img/our-work/technologies/ionic.png" alt="Ionic" />
